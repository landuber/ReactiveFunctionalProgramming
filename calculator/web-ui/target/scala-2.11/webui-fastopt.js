  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) === 0)) {
        var array = [((-$uD(b$2.apply__O())) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var count = $uI(remainingCharsCount$1.apply__O());
      return ((count >= 15) ? "green" : (((count >= 0) && (count < 15)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var name = $as_T(x0$1.$$und1$f);
    var exprSignal = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, exprSignal$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSignal$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(name$1)))
      })
    })(this, name, exprSignal));
    return new $c_T2().init___O__O(name, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
